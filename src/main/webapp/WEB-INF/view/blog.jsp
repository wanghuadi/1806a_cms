	...
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				...
				<div class="text-right">发布时间：<fmt:formatDate value="${article.created}" pattern="yyyy-MM-dd HH:mm:ss"/></div>
			...
			<div class="col-md-4">
				<div class="panel panel-default">
				  ...
				  <div class="panel-body">
				  	<c:forEach items="${hitsOrder}" var="article">
				...
				<div class="panel panel-default">
				  ...
				  <div class="panel-body">
				  	<c:forEach items="${commentsOrder}" var="article">
					    <p><a href="/article/${article.id}">${article.title}</a></p>
				  	</c:forEach>
				  </div>
				</div>
